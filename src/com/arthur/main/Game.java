...
import com.arthur.world.TorreGenerator;
...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public static TorreGenerator torregenerator;
	...
	public Game(){
		...
		player = new Player(WIDTH/3,HEIGHT/2,16,16,1,spritesheet.getSprite(0, 0,16,16));
		torregenerator = new TorreGenerator();
		ui = new UI();
